...
# this file contains functions that draw the various help screen texts
...
def drawHelpText(self, screen):
    ...
    'Change AI difficulty with 1 and 2!',
...
def drawInsText(self, screen):
    lines = [
    '112 Poker Term Project',
    "Texas Hold'em Poker",
    'Instructions:',
    'Raise if you have a good hand,', 
    'Check if you do not want to bet more,',
    'And fold if you have a bad hand', 
    'Win by having the most money :)',
    'Click anywhere to return.'
    ''
    ]
